...
const AlertIcon = () => {
  ...
  return (
    ...
    >
      <defs />
      <g transform="translate(-68.940565,-79.476995)" fill="blue">
        <path
        ...
        <g className={`${styles.upper_bread} ${styles[`upper_bread_${open}`]}`}>
          <path
            fill="yellow"
            d="m 102.29968,110.5978 a 16.240686,9.7108574 0 0 1 -8.120339,8.40985 16.240686,9.7108574 0 0 1 -16.240687,0 16.240686,9.7108574 0 0 1 -8.120342,-8.40985"
          />
          <rect
            fill="yellow"
            width="32.481606"
